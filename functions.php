...
function philosophy_theme_setup() {
    ...
    register_nav_menus(array(
        'footer-quick-links'  => __("Footer Quick Links Menu", 'philosophy'),
        'footer-archives'     => __("Footer Archives Menu", 'philosophy'),
        'footer-social-links' => __("Footer Social Links Menu", 'philosophy'),
    ));
...
function philosophy_widgets() {
    register_sidebar(
        array(
            ...
            'id'            => 'about-us',
            'description'   => __('Widgets in the area will be shown on about us page', 'philosophy'),
    ...
    register_sidebar(
        array(
            ...
            'id'            => 'contact-maps',
            'description'   => __('Widgets in the area will be shown on contact page', 'philosophy'),
    ...
    register_sidebar(
        array(
            'name'          => __('Header Section Social Icons', 'philosophy'),
            'id'            => 'header-section',
            'description'   => __('Widgets in the area will be shown on Header Section', 'philosophy'),
            'before_widget' => '<div id="%1$s" class="%2$s">',
            'after_widget'  => '</div>',
            'before_title'  => '<h3 class="">',
            'after_title'   => '</h3>',
